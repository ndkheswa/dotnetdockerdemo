...
namespace WorldWideImporters.Model
{
    ...
    {
        public static IQueryable<StockItem> GetStockItems(this ApplicationDbContext dbContext, int pageSize = 10, int pageNumber = 1, 
            int? lastEditedBy = null, int? colorID = null, int? outerPackageID = null, int? supplierID = null, int? unitPackageID = null)
        {
        ...
        public static async Task<StockItem> GetStockItemsAsync(this ApplicationDbContext dbContext, StockItem entity)
            => await dbContext.StockItems.FirstOrDefaultAsync(item => item.StockItemID == entity.StockItemID);

        public static async Task<StockItem> GetStockItemsByStockItemNameAsync(this ApplicationDbContext dbContext, StockItem entity)
